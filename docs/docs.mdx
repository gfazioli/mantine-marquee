...
<div className="marquee-iso-demo">
...
On top of that you get responsive `gap` and `vertical`, fade-edge shapes (`linear`, `ellipse`, `rect`), per-axis fade sizes, and the `isometric` 3D variant.
